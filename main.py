    ...
    # --- ÄNDERUNG 4: Alten Start-Block entfernen ---
    # Der if __name__ == '__main__': Block wird nicht mehr benötigt,
    # da init_db() oben aufgerufen wird und Gunicorn die App startet.